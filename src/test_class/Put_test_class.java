...
public class Put_test_class {
	...
	public static void orchestrator() throws IOException 
		{    
			...
			for(int i=0 ; i<5 ; i++) 
	        {
			 responsestatuscode = common_Methods.Put_common_method.responsestatuscode_extractor(baseUri, resource, requestBody);	
			...
			common_Methods.Common_method_utilities.evidenceFileCreator("Put_test_class", requestBody, responseBody);
